...
const FilmGallery = () => {
  const movies = [
    {
      title: "Yhe Shawshank Redemption",
      year: "1994",
  ...
  switch (filter) {
    ...
    case "desc":
      films.sort((a, b) => a.year - b.year).reverse();
  ...
  return (
    <section>
      <button value={"asc"} onClick={(e) => setFilter(e.target.value)}>
        Sort by Date Ascending
      </button>
      <button value={"desc"} onClick={(e) => setFilter(e.target.value)}>
        Sort by Date Descending
      </button>
      <button value={"rate"} onClick={(e) => setFilter(e.target.value)}>
        Best Rate
      </button>
      <button value={"az"} onClick={(e) => setFilter(e.target.value)}>
        A-Z
      </button>
      <button value={"za"} onClick={(e) => setFilter(e.target.value)}>
        Z-A
      </button>
      <input
        type="text"
